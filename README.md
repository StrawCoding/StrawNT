...
> **v0.3.0-cleanroom（Released 2026-07-04）** — Phase 0–7 全部完成。完全重新 clean-room 實作，禁止沿用封存 legacy 程式碼。ISO 已通過 BIOS + UEFI boot test。
...
|------|-----|
| 版本 | `v0.3.0-cleanroom` |
| ISO | `StrawWU-0.3.0-cleanroom-amd64.iso` (6.1 GB) |
...
官方 Ubuntu noble live ISO
   ...
   StrawWU-0.3.0-cleanroom-amd64.iso
```
