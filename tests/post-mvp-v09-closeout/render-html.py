#!/usr/bin/env python3
"""Render StrawWU Post-MVP v0.9 engineering closeout markdown to HTML (hermes-deliver)."""
...
<head>
  ...
  <title>StrawWU Post-MVP v0.9 Engineering Closeout — Definition of Done</title>
  <style>{CSS}</style>
</head>
<body>
  <div class="wrap">
    <header>
      <div class="brand">StrawWU Post-MVP v0.9 Engineering Closeout</div>
      <h1>v0.7–v0.9 工程 track — DoD 驗收</h1>
      <p class="meta">版本 {html.escape(VERSION)} · post-v09-engineering-closeout · hermes-deliver</p>
    </header>
    <main>
{body}
    </main>
    <footer>
      StrawWU v0.9 engineering · 21 Post-MVP stages · Next → official-release (Q9 1.0.0)
    </footer>
  </div>
</body>
</html>
...
def main() -> int:
    md_path = CLOSEOUT_DIR / "post-mvp-v09-dod.md"
    if not md_path.is_file():
        print(f"FAIL: missing {md_path}", file=sys.stderr)
        return 1
    HTML_DIR.mkdir(parents=True, exist_ok=True)
    out_path = HTML_DIR / "post-mvp-v09-closeout-report.html"
