#!/usr/bin/env python3
"""Render StrawWU MVP closeout markdown to self-contained HTML (hermes-deliver)."""
...
<head>
  ...
  <title>StrawWU MVP Closeout — Definition of Done</title>
  <style>{CSS}</style>
</head>
<body>
  <div class="wrap">
    <header>
      <div class="brand">StrawWU MVP Closeout</div>
      <h1>Wave 8 — 全 Wave PASS 驗收</h1>
      <p class="meta">版本 {html.escape(VERSION)} · w8-mvp-closeout · hermes-deliver</p>
    </header>
    <main>
{body}
    </main>
    <footer>
      StrawWU v0.5 MVP · 47 Wave stages · Post-MVP → u26-m1-base-clone
    </footer>
  </div>
</body>
</html>
...
def main() -> int:
    md_path = MVP_DIR / "mvp-dod.md"
    if not md_path.is_file():
        print(f"FAIL: missing {md_path}", file=sys.stderr)
        return 1
    HTML_DIR.mkdir(parents=True, exist_ok=True)
    out_path = HTML_DIR / "mvp-closeout-report.html"
