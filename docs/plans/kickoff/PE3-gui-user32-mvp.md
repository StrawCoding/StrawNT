...
## Goal
Minimal user32/gdi window + message loop; real GUI PE can show/close with screenshot or compositor evidence.
...
## PASS
1. `tests/portable/output/pe-gui.json` top-level status acceptable per stage verify
