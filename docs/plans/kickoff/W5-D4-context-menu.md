...
1. 本階段實作產物（見計畫文件）
2. `docs/plans/stage-reports/W5-D4-context-menu-report.md`
...
Hermes mark PASS → 自動啟動 **w5-r4-install-hooks**（勿問使用者）。
