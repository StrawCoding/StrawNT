...
## Goal
Docs, release artifacts, cross-distro smoke, HTML closeout, pe-closeout.json PASS.
...
## PASS
1. `tests/portable/output/pe-closeout.json` top-level status acceptable per stage verify
