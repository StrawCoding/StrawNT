# Post-MVP — HW T1 live usb

| 任務 ID | post-hw-t1-live-usb |
|---------|-------|
| Track | Post-MVP |
...
≥3 台實機 Live USB；gpu/wifi 非 SKIP
...
1. 本階段實作產物（見計畫文件）
2. `docs/plans/stage-reports/POST-HW-T1-live-usb-report.md`
