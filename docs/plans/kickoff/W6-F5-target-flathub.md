# Wave 6 F5 — target Flathub E2E

| 任務 ID | w6-f5-target-flathub |
|---------|-------|
| Wave | 6 |
| 計畫 | `strawwu-flathub-plan.md` |
| 狀態 | 待執行 |
...
1. 本階段實作產物（見計畫文件）
2. `docs/plans/stage-reports/W6-F5-target-flathub-report.md`
...
Hermes mark PASS → 自動啟動 **w6-b5-meta-audit**（勿問使用者）。
