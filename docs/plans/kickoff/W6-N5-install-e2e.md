# Wave 6 N5 — install + firstboot E2E

| 任務 ID | w6-n5-install-e2e |
|---------|-------|
| Wave | 6 |
...
1. 本階段實作產物（見計畫文件）
2. `docs/plans/stage-reports/W6-N5-install-e2e-report.md`
...
Hermes mark PASS → 自動啟動 **w6-i4-installed-boot**（勿問使用者）。
