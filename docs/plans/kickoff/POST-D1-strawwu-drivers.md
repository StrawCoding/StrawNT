# Post-MVP — D1 strawwu drivers

| 任務 ID | post-d1-strawwu-drivers |
|---------|-------|
| Track | Post-MVP |
| 計畫 | `strawwu-drivers-plan.md` |
| 路線圖 | `strawwu-post-mvp-roadmap.md` |

## 目標

Hub 驅動分頁 + NVIDIA/AMD 策展

## 必讀

- `docs/plans/strawwu-post-mvp-roadmap.md`
- `docs/plans/strawwu-ai-worker-sop.md`
- `docs/plans/strawwu-drivers-plan.md`
...
1. 本階段實作產物（見計畫文件）
2. `docs/plans/stage-reports/POST-D1-strawwu-drivers-report.md`
