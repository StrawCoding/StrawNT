...
## Goal
At least two real public small Win apps start via native with evidence; honest PARTIAL allowed for failures.
...
## PASS
1. `tests/portable/output/pe-golden.json` top-level status acceptable per stage verify
