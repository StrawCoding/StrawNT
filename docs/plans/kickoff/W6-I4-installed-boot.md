# Wave 6 I4 — installed boot

| 任務 ID | w6-i4-installed-boot |
|---------|-------|
| Wave | 6 |
...
1. 本階段實作產物（見計畫文件）
2. `docs/plans/stage-reports/W6-I4-installed-boot-report.md`
...
Hermes mark PASS → 自動啟動 **w6-f5-target-flathub**（勿問使用者）。
