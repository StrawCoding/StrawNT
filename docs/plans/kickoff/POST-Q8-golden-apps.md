# Post-MVP — Q8 golden apps

| 任務 ID | post-q8-golden-apps |
|---------|-------|
| Track | Post-MVP |
...
Office/Steam/Epic/三角洲 launcher
...
1. 本階段實作產物（見計畫文件）
2. `docs/plans/stage-reports/POST-Q8-golden-apps-report.md`
