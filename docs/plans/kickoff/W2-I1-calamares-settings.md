# Wave 2 I1 — strawwu-calamares-settings

| 任務 ID | w2-i1-calamares-settings |
|---------|-------|
| Wave | 2 |
...
1. 本階段實作產物（見計畫文件）
2. `docs/plans/stage-reports/W2-I1-calamares-settings-report.md`
...
Hermes mark PASS → 自動啟動 **w2-r1-app-registry**（勿問使用者）。
