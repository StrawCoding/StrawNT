...
strawwu-install.desktop + finished 文案
...
1. 本階段實作產物（見計畫文件）
2. `docs/plans/stage-reports/W3-I2-live-ux-report.md`
...
Hermes mark PASS → 自動啟動 **w3-b3-update-notifier**（勿問使用者）。
