# Post-MVP — CI kernel selfhosted

| 任務 ID | post-ci-kernel-selfhosted |
|---------|-------|
| Track | Post-MVP |
| 計畫 | `strawwu-post-mvp-roadmap.md` |
| 路線圖 | `strawwu-post-mvp-roadmap.md` |

## 目標

Q6 self-hosted kernel CI
...
make test-ci-kernel-selfhosted
make preflight
# exit 0
```
...
1. 本階段實作產物（見計畫文件）
2. `docs/plans/stage-reports/POST-CI-kernel-selfhosted-report.md`
