# Wave 3 N2 — strawwu-target-setup

| 任務 ID | w3-n2-target-setup |
|---------|-------|
| Wave | 3 |
...
1. 本階段實作產物（見計畫文件）
2. `docs/plans/stage-reports/W3-N2-target-setup-report.md`
...
Hermes mark PASS → 自動啟動 **w3-w0-wincompat-baseline**（勿問使用者）。
