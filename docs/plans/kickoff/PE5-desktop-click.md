...
## Goal
MIME/integrate/menu shortcuts native-only; install.sh has no Wine; double-click open works.
...
## PASS
1. `tests/portable/output/pe-desktop-click.json` top-level status acceptable per stage verify
