# Wave 5 R4 — install 管線 hook

| 任務 ID | w5-r4-install-hooks |
|---------|-------|
| Wave | 5 |
...
1. 本階段實作產物（見計畫文件）
2. `docs/plans/stage-reports/W5-R4-install-hooks-report.md`
...
Hermes mark PASS → 自動啟動 **w5-i3-target-identity**（勿問使用者）。
