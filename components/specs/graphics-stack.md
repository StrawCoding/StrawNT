...
| 模組 | 職責 | v3.0 預期 |
|------|------|-----------|
| strawwu-vk-icd | Win32 可載入的 Vulkan ICD 入口 | PARTIAL |
| strawwu-dxgi-vk | D3D11 常見呼叫翻譯 | PARTIAL |
| strawwu-wgl | OpenGL 1.x/2.x 子集 | PARTIAL |
| present-bridge | 全螢幕、vsync、多螢幕 | PARTIAL |
