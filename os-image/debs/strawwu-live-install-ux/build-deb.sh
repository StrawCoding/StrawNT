#!/usr/bin/env bash
# build-deb.sh — Build strawwu-live-install-ux .deb from usr/ + debian/ templates.
set -euo pipefail
...
mkdir -p "${PKG_DIR}/usr/share/doc/strawwu-live-install-ux"
cat > "${PKG_DIR}/usr/share/doc/strawwu-live-install-ux/copyright" <<'EOF'
Format: https://www.debian.org/doc/packaging-manuals/copyright-format/1.0/
Upstream-Name: strawwu-live-install-ux
...
DEB_FILE="${OUTPUT_DIR}/strawwu-live-install-ux_${VERSION}_all.deb"
