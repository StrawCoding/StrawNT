#!/usr/bin/env bash
# build-deb.sh — Build strawwu-initd .deb from usr/ + debian/ templates.
set -euo pipefail
...
chmod 755 "${PKG_DIR}/usr/bin/strawwu-initd"

mkdir -p "${PKG_DIR}/usr/share/doc/strawwu-initd"
cat > "${PKG_DIR}/usr/share/doc/strawwu-initd/copyright" <<'EOF'
Format: https://www.debian.org/doc/packaging-manuals/copyright-format/1.0/
Upstream-Name: strawwu-initd
...
DEB_FILE="${OUTPUT_DIR}/strawwu-initd_${VERSION}_all.deb"
