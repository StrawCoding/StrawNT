...
stage_debs() {
    ...
    local pkg deb
    for pkg in strawwu-initd strawwu-wincompat strawwu-device-proxy strawwu-shell strawwu-gtk-theme strawwu-icon-theme strawwu-session strawwu-greeter strawwu-update-notifier strawwu-upgrade strawwu-backup strawwu-software-sources strawwu-bug-reporter strawwu-drivers strawwu-laptop \
