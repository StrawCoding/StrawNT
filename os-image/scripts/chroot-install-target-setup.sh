...
stage_debs() {
    ...
    local pkg deb
    for pkg in strawwu-initd strawwu-wincompat strawwu-shell strawwu-session strawwu-greeter strawwu-update-notifier strawwu-bug-reporter strawwu-drivers strawwu-laptop \
